...
<div class="site-index">
    ...
    <div class="jumbotron">
        <h2>Добро пожаловать, <?= yii::$app->user->identity->username ?></h2><br>
        <p>
            <?php
                if (User::findIdentity(Yii::$app->user->id)->status_adm === 1) { ?>
                    <?= Html::a('Удалить', ['delete', 'id' => $newsso->id], [
                    ...
                    <?= Html::a('Редактирование', ['update', 'id' => $newsso->id], ['class' => 'btn btn-primary']); ?>
                <?php } ?>
